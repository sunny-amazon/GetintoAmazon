...
<section class="u-align-center u-clearfix u-section-1" id="sec-a21f">
  <div class="u-clearfix u-sheet u-valign-middle-md u-valign-middle-sm u-valign-middle-xs u-sheet-1" style="min-height: auto;">
	<div id="comments" class="comments-area">
		<?php if ( have_comments() ) : ?>
			<h3 class="comments-title">
				...
				if ( 1 === $comments_number ) {
					...
					printf( _x( 'One thought on &ldquo;%s&rdquo;', 'comments title', 'getintoamazonweb' ), get_the_title() );
				} else {
					printf(
			...
			<ol class="comment-list">
				...
				$comments_html = str_replace(
					...
					wp_list_comments(array(
						...
						'short_ping'  => true,
						'avatar_size' => 42,
						'reply_text'  => '' . __('Reply', 'getintoamazonweb') . '',
						'echo'        => false,
					))
				);
		...
		if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) :
			?>
			<p class="no-comments "><?php _e( 'Comments are closed.', 'getintoamazonweb' ); ?></p>
		<?php endif; ?>
